 ...
 */
export interface MassPromotionHandler {
  readonly target: PromotionTarget;
  promote(
    mass: MassingObjectRecord,
    options?: Readonly<Record<string, unknown>>,
  ): Promise<Result<{ readonly targetId: Id }>>;
}

export const MassPromotionHandlerToken =
  createCapabilityToken<MassPromotionHandler>("massing.promotion-handler");
...
export interface MassingEvents {
  ...
  "massing.profile.created": { readonly record: ProfileRecord };
  "massing.profile.updated": { readonly record: ProfileRecord };
